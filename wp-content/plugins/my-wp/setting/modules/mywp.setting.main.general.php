  ...
  public static function mywp_current_setting_screen_content() {
    ...
    <div class="about-column column-main-right">
      ...
      <div class="left">
        ...
        <p>
          <a href="<?php echo esc_url( admin_url( 'admin.php?page=mywp_admin' ) ); ?>" class="button"><?php _e( 'Admin Customize' , 'my-wp' ); ?></a>
    ...
    <div class="about-column column-main-left">
      <div class="right">
        ...
        <p>
          <a href="<?php echo esc_url( admin_url( 'admin.php?page=mywp_frontend' ) ); ?>" class="button"> <?php _e( 'Frontend Customize' , 'my-wp' ); ?></a>
        </p>
      </div>
    ...
    <div class="about-column column-main-right">
      ...
      <div class="left">
        ...
        <p>
          <a href="<?php echo esc_url( admin_url( 'admin.php?page=mywp_debug' ) ); ?>" class="button"><?php _e( 'Debug' , 'my-wp' ); ?></a>
    ...
    <div class="about-column column-main-left">
      <div class="right">
        ...
        <p>
          <a href="<?php echo esc_url( $plugin_info['website_url'] ); ?>add-ons/" class="button" target="_blank"> <?php _e( 'Add-ons' , 'my-wp' ); ?></a>
        </p>
      </div>
