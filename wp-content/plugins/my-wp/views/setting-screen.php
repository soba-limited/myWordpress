      ...
      <div id="setting-screen-section-wrap">
        ...
        <div id="setting-screen-section">
          ...
          <?php if( ! empty( $current_setting_screen['document_url'] ) ) : ?>
            ...
            <p id="setting-document-link">
              <a href="<?php echo esc_url( $current_setting_screen['document_url'] ); ?>" target="_blank" class="button"><span class="dashicons dashicons-welcome-learn-more"></span> <?php printf( __( '%s Documentation' , 'my-wp' ) , $current_setting_screen['title'] ); ?></a>
            </p>
